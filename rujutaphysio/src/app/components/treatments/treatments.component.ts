...
export class TreatmentsComponent implements OnInit {
  ...
  ngOnInit(): void {
        ...
        this.eventsTile[0] = {id:1, color: 'none', cols: 1, rows: 1, name:"Indian Head Massage",image:"/assets/images/Indian Head Massage.jpg",
                             imageRef:"Image by cookie_studio on Freepik", price1:"25 Pounds", price2: "35", price3:"45",time1:"30 min", 
        ...
        this.eventsTile[1] = {id:2, color: 'none', cols: 1, rows: 1, name:"Deep Tissue Massage",image:"/assets/images/Deep Tissue Massage.jpg",
                             imageRef:"Photo by Toa Heftiba on Unsplash", price1:"25 Pounds", price2: "35", price3:"45",time1:"30 min", 
        ...
        this.eventsTile[2] = {id:3, color: 'none', cols: 1, rows: 1, name:"Aromatherapy",image:"/assets/images/Aromatherapy.jpg",
                             imageRef:"Photo by Mariana Rascão on Unsplash", price1:"25 Pounds", price2: "35", price3:"45",time1:"30 min", 
        ...
        this.eventsTile[3] = {id:4, color: 'none', cols: 1, rows: 1, name:"Sports Massage",image:"/assets/images/Sports Therapy.jpg",
                             imageRef:"Photo by Toralf Thomassen on Unsplash", price1:"25 Pounds", price2: "35", price3:"45",time1:"30 min", 
                             time2:"45 min", time3:"60 min",info:"Similar to deep tissue massages but target the specific areas of body which require healing. Typically these are given as treatment programmes for sports related injuries and for injury prevention."
                             }
         this.eventsTile[4] = {id:5, color: 'none', cols: 1, rows: 1, name:"Physiotherapy",image:"/assets/images/Physiotherapy.jpg",
                             imageRef:"Photo by Sincerely Media on Unsplash", price1:"25 Pounds", price2: "35", price3:"45",time1:"30 min", 
                             time2:"45 min", time3:"60 min",info:"Online consultation also available. 10 pounds."
                             }                     
