...
export class TreatmentsComponent implements OnInit {
  ...
  ngOnInit(): void {
        ...
        this.eventsTile[0] = {id:1, color: 'none', cols: 1, rows: 1, name:"Indian Head Massage",image:"/rujutaProduction/assets/images/Indian Head Massage.jpg",
        ...
        this.eventsTile[1] = {id:2, color: 'none', cols: 1, rows: 1, name:"Deep Tissue Massage",image:"/rujutaProduction/assets/images/Deep Tissue Massage.jpg",
        ...
        this.eventsTile[2] = {id:3, color: 'none', cols: 1, rows: 1, name:"Aromatherapy",image:"/rujutaProduction/assets/images/Aromatherapy.jpg",
        ...
        this.eventsTile[3] = {id:4, color: 'none', cols: 1, rows: 1, name:"Sports Massage",image:"/rujutaProduction/assets/images/Sports Therapy.jpg",
         ...
         this.eventsTile[4] = {id:5, color: 'none', cols: 1, rows: 1, name:"Physiotherapy",image:"/rujutaProduction/assets/images/Physiotherapy.jpg",
